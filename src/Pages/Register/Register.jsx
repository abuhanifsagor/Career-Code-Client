...
import resgisterAnimation from "../../assets/res.json";
...
const Register = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center gap-5">
      <div
        className="w-full max-w-md p-8 space-y-3 rounded-xl bg-base-200 "
        bis_skin_checked="1"
      >
        ...
        <div className="flex items-center pt-4 space-x-1" bis_skin_checked="1">
          <div
            ...
            bis_skin_checked="1"
          ></div>
          <p className="px-3 text-sm   ">Or continue with social accounts</p>
          <div
            className="flex-1 h-px sm:w-16 dark:bg-gray-300"
            bis_skin_checked="1"
          ></div>
